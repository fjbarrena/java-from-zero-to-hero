...
public class Action implements Serializable {
    ...
    private Date date;
    @JoinColumn(name = "gochi", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private MyGochis gochi;
    ...
    public Action(Integer id, Date date) {
        this.id = id;
        this.date = date;
    }
    ...
    public MyGochis getGochi() {
        return gochi;
    }

    public void setGochi(MyGochis gochi) {
        this.gochi = gochi;
    }
    ...
    public String toString() {
        return "es.iti.formacion.tecnogochi.model.Action[ id=" + id + " ]";
    }
